    ...
    <div className="min-h-screen bg-ink flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="font-serif text-4xl text-cream">Start your hunt.</h1>
          <p className="mt-2 text-cream2 text-sm">7-day free trial · no card required.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="border border-line2 rounded-xl bg-ink2/60 p-7 space-y-5">
          ...
          <div className="space-y-1.5">
            <label className="font-mono text-[11px] uppercase tracking-wider text-cream2">Confirm Password</label>
            <input
              type="password"
              value={confirm}
        ...
        <p className="mt-5 text-center text-sm text-cream2">
          ...
          <Link to="/login" className="text-amber hover:underline underline-offset-4">
            Sign in
          </Link>
        </p>
      </div>
