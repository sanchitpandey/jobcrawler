...
def get_settings() -> Settings:
    return Settings(
        ...
        apply=ApplySettings(
            linkedin_email=os.environ.get("LINKEDIN_EMAIL", "sanchitpandey72@gmail.com"),
            linkedin_password=os.environ.get("LINKEDIN_PASS"),
            indeed_email=os.environ.get("INDEED_EMAIL", "your@email.com"),
            indeed_password=os.environ.get("INDEED_PASSWORD", "your_indeed_password"),
